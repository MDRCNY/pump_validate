...
measured on multiple outcomes, researchers typically apply a multiple
...
findings, but also results in a change in statistical power, sometimes
...
\begin{center}\includegraphics{PUMP_Manuscript_files/figure-latex/unnamed-chunk-5-1} \end{center}
...
\begin{center}\includegraphics{PUMP_Manuscript_files/figure-latex/unnamed-chunk-6-1} \end{center}
...
\FunctionTok{ggplot}\NormalTok{( grid, }\FunctionTok{aes}\NormalTok{( ICC}\FloatTok{.2}\NormalTok{, min1, }\AttributeTok{group =}\NormalTok{ ICC}\FloatTok{.3}\NormalTok{, }\AttributeTok{col =}\NormalTok{ ICC}\FloatTok{.3}\NormalTok{ ) ) }\SpecialCharTok{+}
    ...
    \FunctionTok{labs}\NormalTok{( }\AttributeTok{y =} \StringTok{"Min{-}1 Power"}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{PUMP_Manuscript_files/figure-latex/unnamed-chunk-13-1} \end{center}
...
\begin{center}\includegraphics{PUMP_Manuscript_files/figure-latex/unnamed-chunk-15-1} \end{center}
...
\leavevmode\vadjust pre{\hypertarget{ref-MiratrixWeiss2020}{}}%
