...
For the purposes of computing power researchers specify an alternative hypothesis of at least a particular effect size. For example, researchers may specify an ES of $0.125$.
...
For two-tailed tests, $MT_{df} = t_{\alpha/2} + t_{1-\beta}$.
...
<!--KH response: it seems like most of the most relevant information from Section 1 has already been summarized here. I am missing details like the definition of ICC, omega, and all the other parameters--is that what you mean?  It does seem like that goes pretty far into nitty-gritty details.  -->
