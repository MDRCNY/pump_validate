...
#powname<-paste0(design[1], "M", M, "n.j", n.j, "J", J, "MDES", MDES[1], "rho", rho, "_power.Rda")



#run power function
#powname <- power.blockedRCT.2(M, MDES, J, n.j,
#                    p, alpha, numCovar.1, numCovar.2, R2.1, R2.2, ICC, 
#                    mod.type = "constant", sigma, omega = NULL,
#                    tnum=tnum, snum=snum, ncl)
#}
#####################################################################
...
#fname<- paste0(fdir,powname)
#save(powname, file=fname)
