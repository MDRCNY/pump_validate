...
est.power <- function(procs, M,DMDES,n.j,J,rho.0_lev1, rho.0_lev2,rho.1_lev2,theta,ICC,alpha, Gamma.00,sig.sq, 
                      p.j.range, R2.1, R2.2, check, omega, funct, S, ncl, B, maxT) {
