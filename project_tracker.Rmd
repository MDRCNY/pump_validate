...
- edits on shiny documentation
- search for papers in JSS
- write conclusion

Priority 2

- set up Jonathan S for testing
...
- update WY documentation
- recruit Evan as reader
...
- one tailed v. two tailed power
- update() for pump_sample, pump_mdes
