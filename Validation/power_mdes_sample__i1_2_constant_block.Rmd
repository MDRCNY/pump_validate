...
### rho = 0.0 & numFalseNulls = M

```{r rho0.0numFalseMSpecs, warning = FALSE, message = FALSE }
...
pander::pandoc.table(blocked_i1_2c_compare_results, paste0("PowerSimulation_", "rho_", rho,"_falseNull_",M), 
                     style = "rmarkdown", split.tables = 90)
```
...
### MDES Bonferroni Validation

```{r}
power_M3_BF_MDES0125[power_M3_BF_MDES0125$MTP ]
```
...
power_M3_BF_MDES0125 <- pum::power_blocked_i1_2c(M = M, MTP = "Bonferroni", MDES = MDES, numFalse = numFalse, J = J, n.j = n.j, 
                         R2.1 = R2.1, p = p, alpha = alpha, numCovar.1 = numCovar.1, numCovar.2 = numCovar.2,
...
pander::pandoc.table(power_M3_BF_MDES0125, style = "rmarkdown", split.tables = 90)
```

```{r mdesBonfIndiv}
mdes_0125_bonf_indiv <- pum::mdes_blocked_i1_2c(M = M, numFalse = numFalse,J = J, n.j = n.j, power = power_M3_BF_MDES0125[which(power_M3_BF_MDES0125$MTP == "BF"), "indiv"],
...
toc()
pander::pandoc.table(mdes_0125_bh_indiv, style = "rmarkdown")
```
...
### Non-Individual Power for MDES is Working Now
