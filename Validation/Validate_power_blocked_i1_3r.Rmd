...
Blocked RCT, with 3 levels, and randomization done at level 1 (individual level). This document contains models assuming constant treatment effects, fixed treatment effects, and random treatment effects.
...
```{r 3r.ICC20.8}
blocked_i1_3r_ICC2.0.8_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(blocked_i1_3r_ICC2.0.8_power_plot)
...
```{r 3r.ICC30.8}
blocked_i1_3r_ICC3.0.8_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(blocked_i1_3r_ICC3.0.8_power_plot)
