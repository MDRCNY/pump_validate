...
{
  blocked_i1_2c_mdes_D1_results <- readRDS(mdes.file)
  pander::pandoc.table(
    blocked_i1_2c_mdes_D1_results,
...
{
  blocked_i1_2c_mdes_min2_results <- readRDS(mdes.file)
  pander::pandoc.table(
...
{
  blocked_i1_2f_mdes_D1_results <- readRDS(mdes.file)
  pander::pandoc.table(
    blocked_i1_2f_mdes_D1_results,
    style = "grid", split.tables = 100, row.names = FALSE, 
    caption = design
  )    
}
...
{
  blocked_i1_2f_mdes_min2_results <- readRDS(mdes.file)
  pander::pandoc.table(
    blocked_i1_2f_mdes_min2_results,
    style = "grid", split.tables = 100, row.names = FALSE, 
    caption = design
  )    
}
...
{
  blocked_i1_2r_mdes_D1_results <- readRDS(mdes.file)
  pander::pandoc.table(
    blocked_i1_2r_mdes_D1_results,
    style = "grid", split.tables = 100, row.names = FALSE, 
    caption = design
  )
}
...
{
  blocked_i1_2r_mdes_min2_results <- readRDS(mdes.file)
  pander::pandoc.table(
    blocked_i1_2r_mdes_min2_results,
    style = "grid", split.tables = 100, row.names = FALSE, 
    caption = design
  )
}
...
{
  blocked_i1_2c_sample_D1_results <- readRDS(sample.file)
  pander::pandoc.table(
    blocked_i1_2c_sample_D1_results,
    style = "grid", split.tables = 100, row.names = FALSE,
    caption = design
  )
}
...
{
  blocked_i1_2c_sample_min2_results <- readRDS(sample.file)
  pander::pandoc.table(
...
{
  blocked_i1_2f_sample_D1_results <- readRDS(sample.file)
  pander::pandoc.table(
    blocked_i1_2f_sample_D1_results,
    style = "grid", split.tables = 100, row.names = FALSE,
    caption = design
  )
}
...
{
  blocked_i1_2f_sample_min2_results <- readRDS(sample.file)
  pander::pandoc.table(
    blocked_i1_2f_sample_min2_results,
    style = "grid", split.tables = 100, row.names = FALSE,
    caption = design
  )
}
...
{
  blocked_i1_2r_sample_D1_results <- readRDS(sample.file)
  pander::pandoc.table(
    blocked_i1_2r_sample_D1_results,
    style = "grid", split.tables = 100, row.names = FALSE,
    caption = design
  )
}
...
{
  blocked_i1_2r_sample_min2_results <- readRDS(sample.file)
  pander::pandoc.table(
    blocked_i1_2r_sample_min2_results,
    style = "grid", split.tables = 100, row.names = FALSE,
    caption = design
  )
}
