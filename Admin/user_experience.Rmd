...
- A user likely will ask for MDES for multiple types of power, is there a way to exploit previous power calculations? Is it worth it?
- Fix expected time diff for simulation!
- Sample size if MDES is different for different outcomes. Not supported!!
- Always assumes two.tailed, one tailed not implemented
