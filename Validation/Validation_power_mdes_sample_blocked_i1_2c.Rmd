...
```{r}
tic()
mdes_0125_bonf <- pum::mdes_blocked_i1_2c(M = 6, numFalse = 6,J = 20, n.j = 100, power = 0.9053167,
...
toc()
print(mdes_0125_bonf)
```

```{r}
tic()
mdes_0125_bh <- pum::mdes_blocked_i1_2c(M = 6, numFalse = 6,J = 20, n.j = 100, power = 0.9730000,
...
```{r}
tic()
mdes_0125_holms <- pum::mdes_blocked_i1_2c(M = 6, numFalse = 6,J = 20, n.j = 100, power = 0.9593667,
                                          power.definition = "indiv", MTP = "HO", marginError = 0.05,
                                          p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL,
                                          R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", 
                                          rho = 0.5, omega = NULL,tnum = 10000, snum = 2000, ncl = 8)
toc()
print(mdes_0125_holms)
```
