...
```{r echo = FALSE}
print( m2 )
# knitr::kable( m2, digits = 2, booktabs = TRUE, position = "h!", caption = "" ) %>%
#  kableExtra::kable_styling(position = "center")
```
...
```{r echo = FALSE}
#knitr::kable( m3, digits = 2, booktabs = TRUE ) %>%
#  kableExtra::kable_styling(position = "center")
print( m3 )
```
...
```{r echo = FALSE}
# knitr::kable( smp, digits = 2, booktabs = TRUE ) %>%
#   kableExtra::kable_styling(position = "center")
print( smp )
```
...
```{r echo = FALSE}
knitr::kable( p_check, digits = 2, booktabs = TRUE,
