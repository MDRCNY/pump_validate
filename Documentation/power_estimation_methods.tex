...
\end{tabular}
\caption{Correspondence between design names\label{tab:estimate_param}}
\end{table}
...
\textbf{Characterization:} 3-level design, random intercepts for schools, fixed intercepts for districts, fixed slopes/treatment effects for districts, random intercepts for schools, constant slope/effects for schools within a district, school covariates for intercept.
