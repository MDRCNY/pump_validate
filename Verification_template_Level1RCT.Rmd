---
title: "Validation Template for 1-Level RCT"
...
Try to source an RMD file into an RMD file - doesnt work 
```{r message=FALSE, results='hide'}
knit("~/R/Power-Under-Multiplicity/powerFunctions.Rmd", tangle=TRUE)
source("myfile.R")
```
