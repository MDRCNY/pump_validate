...
## next steps - sim: append tables nto one - do the same for power calc via pum app?
```
...
##Q for ZH: What is sigma vs rho? Is sigma related to rho in the code? Is sigma a matrix of rho? Do I need to reset rho and sigma in the parameters for each correlation? Is sigma set to 1 number or a matrix?
