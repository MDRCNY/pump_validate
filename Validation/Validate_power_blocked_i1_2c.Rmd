...
comparison.file <- find_comparison_file(params.file.base)
blocked_i1_2c_compare_results_nj100 <- readRDS(comparison.file)
...
params.file.base <- gen_params_file_base(user.params.list, sim.params.list, design)
comparison.file <- find_comparison_file(params.file.base)
blocked_i1_2c_compare_results_nj75 <- readRDS(comparison.file)
...
params.file.base <- gen_params_file_base(user.params.list, sim.params.list, design)
comparison.file <- find_comparison_file(params.file.base)
blocked_i1_2c_compare_results_nj50 <- readRDS(comparison.file)
