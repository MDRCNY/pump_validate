---
title: "Validate Power: cluster_c2"
...
```{r 2r.ICC20.5nj50}
cluster_c2_2r_ICC2.0.5_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(cluster_c2_2r_ICC2.0.5_power_plot)
