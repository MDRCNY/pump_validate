...
design <- "blocked_c2_3r"
user.params.list[['omega.3']] <- params.default[['omega.3']]
blocked_c2_3r_r2.2_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(blocked_c2_3r_r2.2_power_plot)
```
...
design <- "blocked_c2_3r"
user.params.list[['omega.3']] <- params.default[['omega.3']]
blocked_c2_3r_rho0.2_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(blocked_c2_3r_rho0.2_power_plot)
```
...
design <- "blocked_c2_3r"
user.params.list[['omega.3']] <- params.default[['omega.3']]
blocked_c2_3r_rho0.8_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(blocked_c2_3r_rho0.8_power_plot)
```
...
design <- "blocked_c2_3r"
user.params.list[['omega.3']] <- params.default[['omega.3']]
blocked_c2_3r_mdes0.1250.00.0.00_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(blocked_c2_3r_mdes0.1250.00.0.00_power_plot)
```
...
design <- "blocked_c2_3f"
user.params.list[['omega.3']] <- 0
blocked_c2_3f_ICC2.0.8_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(blocked_c2_3f_ICC2.0.8_power_plot)
```

```{r 3r.ICC20.8}
design <- "blocked_c2_3r"
user.params.list[['omega.3']] <- params.default[['omega.3']]
blocked_c2_3r_ICC2.0.8_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(blocked_c2_3r_ICC2.0.8_power_plot)
```
...
design <- "blocked_c2_3f"
user.params.list[['omega.3']] <- 0
blocked_c2_3f_ICC3.0.8_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(blocked_c2_3f_ICC3.0.8_power_plot)
```

```{r 3r.ICC30.8}
design <- "blocked_c2_3r"
user.params.list[['omega.3']] <- params.default[['omega.3']]
blocked_c2_3r_ICC3.0.8_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(blocked_c2_3r_ICC3.0.8_power_plot)
```
...
design <- "blocked_c2_3f"
user.params.list[['omega.3']] <- 0
blocked_c2_3f_omega2.0.8_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(blocked_c2_3f_omega2.0.8_power_plot)
```

```{r 3r.omega20.8}
design <- "blocked_c2_3r"
user.params.list[['omega.3']] <- params.default[['omega.3']]
blocked_c2_3r_omega2.0.8_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(blocked_c2_3r_omega2.0.8_power_plot)
```
...
```{r 3f.omega20.8omega30.8}
design <- "blocked_c2_3f"
user.params.list[['omega.3']] <- 0
blocked_c2_3f_omega2.0.8omega3.0.8_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(blocked_c2_3f_omega2.0.8omega3.0.8_power_plot)
```

```{r 3r.omega20.8omega30.8}
design <- "blocked_c2_3r"
user.params.list[['omega.3']] <- params.default[['omega.3']]
blocked_c2_3r_omega2.0.8omega3.0.8_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(blocked_c2_3r_omega2.0.8omega3.0.8_power_plot)
```

```{r omega2omega3.reset}
user.params.list[['omega.2']] <- 0.8
user.params.list[['omega.3']] <- 0.8
```