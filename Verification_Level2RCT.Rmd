...
#save these files 
save(power.corr0, power.corr0.2, power.corr0.5, power.corr0.8, file = "power_corr_ds.RData")

power_corr_ds<- load("power_corr_ds.RData")


write.table(power.corr0, "power_corr0.csv", row.names=FALSE, col.names = TRUE)
t0<- read.table("power_corr0.csv")


saveRDS(power.corr0, "power_corr0.rds")
saveRDS(power.corr0.2, file = "power_corr02.rds")
saveRDS(power.corr0.5, file = "power_corr05.rds")
saveRDS(power.corr0.8, file = "power_corr08.rds")

power.corr0.m<- load("power_corr0.rds")
power.corr0.2.m<- load("power_corr02.rda")
power.corr0.5.m<- load("power_corr05.rda")
power.corr0.8<- load("power_corr08.rda")
...
MDEStest <- function(powerds, mtpn, defn, corr){
 ...
 return(c(bool, test.MDES))
}

MDEStest(power.corr0, "BH", "indiv", 0)
MDEStest(power.corr0, "BH", "min1", 0)
