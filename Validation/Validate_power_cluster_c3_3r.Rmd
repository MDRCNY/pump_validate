...
```{r 3r.ICC20.8}
cluster_c3_3r_ICC2.0.5_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(cluster_c3_3r_ICC2.0.5_power_plot)
...
```{r 3r.ICC30.8}
cluster_c3_3r_ICC3.0.8_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(cluster_c3_3r_ICC3.0.8_power_plot)
