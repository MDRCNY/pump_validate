...
#files
fil1 <- "Blocked_i1_2cM6n.j100J20ICC0MDES0.125rho0.5_S3B200_R2.10_R2.20_sim.Rda"
fil2 <- "Blocked_i1_2cM6n.j50J20MDES0.125rho0.5_power.Rda"

#load files
load(paste0(fdir,fil1))
load(paste0(fdir,fil2))
```
