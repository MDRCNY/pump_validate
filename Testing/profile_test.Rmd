...
```{r}
power_blocked_i1_2c(M = 5, MDES = 0.125, numFalse = 3 , J = 10 , n.j = 10, R2.1 = 0.5 , p = 0.5 , alpha = 0.05 , numCovar.1 = 5 , numCovar.2 = NULL, ICC = NULL, tnum = 10000, snum = 100, updateProgress = NULL)
```
...
```{r}
power_blocked_i1_2c(M = 10, MDES = 0.125, numFalse = 3 , J = 10 , n.j = 100, R2.1 = 0.5 , p = 0.5 , alpha = 0.05 , numCovar.1 = 5 , numCovar.2 = NULL, ICC = NULL, tnum = 10000, snum = 10, updateProgress = NULL)
```
...
```{r}
power_blocked_i1_2c(M = 10, MDES = 0.125, numFalse = 3 , J = 10 , n.j = 100, R2.1 = 0.5 , p = 0.5 , alpha = 0.05 , numCovar.1 = 5 , numCovar.2 = NULL, ICC = NULL, tnum = 10000, snum = 100, updateProgress = NULL)
```
...
```{r}
power_blocked_i1_2c(M = 10, MDES = 0.125, numFalse = 3 , J = 10 , n.j = 100, R2.1 = 0.5 , p = 0.5 , alpha = 0.05 , numCovar.1 = 5 , numCovar.2 = NULL, ICC = NULL, tnum = 10000, snum = 200, updateProgress = NULL)
```
...
```{r}
power_blocked_i1_2c(M = 10, MDES = 0.125, numFalse = 3 , J = 50 , n.j = 100, R2.1 = 0.5 , p = 0.5 , alpha = 0.05 , numCovar.1 = 5 , numCovar.2 = NULL, ICC = NULL, tnum = 10000, snum = 500, updateProgress = NULL)
```
...
```{r}
power_blocked_i1_2c(M = 10, MDES = 0.125, numFalse = 3 , J = 50 , n.j = 100, R2.1 = 0.5 , p = 0.5 , alpha = 0.05 , numCovar.1 = 5 , numCovar.2 = NULL, ICC = NULL, tnum = 10000, snum = 1000, updateProgress = NULL)
```
...
```{r}
mdes_blocked_i1_2c(M = 5, numFalse = 5, J = 10, n.j = 10, power = 0.75, power.definition = "indiv", MTP = "BH", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", rho = 0.99, omega = NULL,tnum = 10000, snum = 10, ncl = 2, updateProgress = NULL)
```
...
```{r}
mdes_blocked_i1_2c(M = 10, numFalse = 5, J = 10, n.j = 100, power = 0.75, power.definition = "indiv", MTP = "BH", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", omega = NULL,tnum = 10000, snum = 100, rho = 0.99, ncl = 2, updateProgress = NULL)
```
...
```{r}
mdes_blocked_i1_2c(M = 10, numFalse = 5, J = 10, n.j = 100, power = 0.75, power.definition = "indiv", MTP = "BH", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", omega = NULL, rho = 0.99,tnum = 10000, snum = 1000, ncl = 2, updateProgress = NULL)
```
...
```{r}
mdes_blocked_i1_2c(M = 10, numFalse = 5, J = 10, n.j = 100, power = 0.5, power.definition = "indiv", MTP = "BH", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", omega = NULL,tnum = 10000, rho = 0.99, snum = 1000, ncl = 2, updateProgress = NULL)
```
...
```{r}
mdes_blocked_i1_2c(M = 10, numFalse = 5, J = 10, n.j = 100, power = 0.5, power.definition = "min1", MTP = "BH", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", omega = NULL,tnum = 10000, rho = 0.99, snum = 1000, ncl = 2, updateProgress = NULL)
```
...
```{r}
mdes.complete <- mdes_blocked_i1_2c(M = 10, numFalse = 5, J = 10, n.j = 100, power = 0.5, power.definition = "complete", MTP = "BH", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", rho = 0.99, omega = NULL,tnum = 10000, snum = 1000, ncl = 2, updateProgress = NULL)
```
...
```{r}
mdes.holm.indiv <- mdes_blocked_i1_2c(M = 10, numFalse = 5,J = 10, n.j = 100, power = 0.80, power.definition = "indiv", MTP = "HO", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", omega = NULL,tnum = 10000, snum = 1000, ncl = 2, rho = 0.99, updateProgress = NULL)
...
```{r}
mdes.holm.min1 <- mdes_blocked_i1_2c(M = 10, numFalse = 5, J = 10, n.j = 100, power = 0.80, power.definition = "min1", MTP = "HO", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", omega = NULL,tnum = 10000, rho = 0.99, snum = 1000, ncl = 2, updateProgress = NULL)
...
```{r}
mdes.holm.complete.01 <- mdes_blocked_i1_2c(M = 10, numFalse = 5,J = 10, n.j = 100, power = 0.80, power.definition = "complete", MTP = "HO", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", omega = NULL,tnum = 10000, rho = 0.99, snum = 1000, ncl = 2, updateProgress = NULL)
...
```{r}
start <- Sys.time()
mdes.holm.complete.02 <- mdes_blocked_i1_2c(M = 10, numFalse = 10, J = 10, n.j = 100, power = 0.80, power.definition = "complete", MTP = "HO", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", omega = NULL,tnum = 10000, snum = 1000, rho = 0.99, ncl = 2, updateProgress = NULL)
...
```{r}
mdes.wyss.indiv.10 <- mdes_blocked_i1_2c(M = 10, numFalse = 5, J = 10, n.j = 100, power = 0.80, power.definition = "indiv", MTP = "WY-SS", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", omega = NULL,tnum = 10000, snum = 10, rho = 0.99, ncl = 2, updateProgress = NULL)
...
```{r}
mdes.wyss.indiv.20 <- mdes_blocked_i1_2c(M = 10, numFalse = 5, J = 10, n.j = 100, power = 0.80, power.definition = "indiv", MTP = "WY-SS", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", omega = NULL,tnum = 10000, snum = 20, rho = 0.99, ncl = 2, updateProgress = NULL)
...
```{r}
mdes.wyss.indiv.100 <- mdes_blocked_i1_2c(M = 10, numFalse = 10, J = 10, n.j = 100, power = 0.80, power.definition = "indiv", MTP = "WY-SS", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", omega = NULL,tnum = 10000, snum = 100, rho = 0.99, ncl = 2, updateProgress = NULL)
print(mdes.wyss.indiv.100)
```
...
```{r}
start <- Sys.time()
mdes.wyss.indiv.500 <- mdes_blocked_i1_2c(M = 10, numFalse = 10, J = 10, n.j = 100, power = 0.80, power.definition = "indiv", MTP = "WY-SS", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", omega = NULL,tnum = 10000, rho = 0.99, snum = 500, ncl = 2, updateProgress = NULL)
...
```{r}
start <- Sys.time()
mdes.wyss.indiv.1000 <- mdes_blocked_i1_2c(M = 10, numFalse = 10, J = 10, n.j = 100, power = 0.80, power.definition = "indiv", MTP = "WY-SS", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", omega = NULL,tnum = 10000, rho = 0.99, snum = 1000, ncl = 2, updateProgress = NULL)
...
```{r}
start <- Sys.time()
mdes.wyss.min1.1000 <- mdes_blocked_i1_2c(M = 10, numFalse = 10, J = 10, n.j = 100, power = 0.80, power.definition = "min1", MTP = "WY-SS", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", omega = NULL,tnum = 10000, rho = 0.99, snum = 1000, ncl = 2, updateProgress = NULL)
...
```{r}
start <- Sys.time()
mdes.wyss.complete.1000 <- mdes_blocked_i1_2c(M = 5, numFalse = 5, J = 10, n.j = 100, power = 0.80, power.definition = "complete", MTP = "WY-SS", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", omega = NULL,tnum = 10000, rho = 0.99, snum = 1000, ncl = 2, updateProgress = NULL)
...
```{r}
start <- Sys.time()
mdes.wyss.complete.1000 <- mdes_blocked_i1_2c(M = 10, numFalse = 10, J = 10, n.j = 100, power = 0.80, power.definition = "complete", MTP = "WY-SS", marginError = 0.05, p = 0.5, alpha = 0.05, numCovar.1 = 5, numCovar.2 = NULL, R2.1 = 0.5, R2.2 = 0, ICC = 0, mod.type = "constant", omega = NULL,tnum = 10000, rho = 0.99, snum = 1000, ncl = 2, updateProgress = NULL)
print(mdes.wyss.complete.1000)
end <- Sys.time()
elapsed <- end-start
print(elapsed)
...
### Test case 1 for Sample Size

For test case 1 of Sample Size, we have

* MTP = Bonferonni
* Number_Of_Outcomes = 5
* Number_Of_FalseNulls = 3
* Type_of_Sample = Blocked_or_within_block
* Number_of_Blocks = XX (We are providing starting values here?)
* Number_of_Units_Per_Block = XX (We are providing starting values here?)
* Alpha_Value = 0.05
...
* alpha_mdes = 0.05
* Power_Value = 0.75
* Power_Definition = Individual
* Proportion_of_Treatment_Assignment = 0.75
* MDEFS = 0.125

```{r}
test_case_1 <- sample_blocked_i1_2c(M = 5, 
                               numFalse = 5, 
                               typesample = "J", 
                               J = NULL, 
                               n.j = 20, 
                               J0 = 10, 
                               n.j0 = NULL, 
                               MDES = 0.125, # what if we have varying MDES, how would we handle the sample calculation?
                               power = 0.8,
                               power.definition = "indiv",
                               MTP = "BF",
                               marginError = 0.05,
...
### Test case 2 for Sample Size with Holms MTP

For test case 2 of Sample Size, we have
...
```{r}
test_case_2 <- sample_blocked_i1_2c(M = 5, 
                               numFalse = 5, 
                               typesample = "J", 
                               J = NULL, 
                               n.j = 20, 
...
For test case 3 of Sample Size, we have

* MTP = Benjamini-Hocheberg
* Number_Of_Outcomes = 5
* Number_Of_FalseNulls = 3
* Type_of_Sample = Blocked_or_within_block
* Number_of_Blocks = XX (We are providing starting values here?)
...
```{r}
test_case_3 <- sample_blocked_i1_2c(M = 5, 
                               numFalse = 5, 
                               typesample = "J", 
                               J = NULL, 
                               n.j = 20, 
...
For test case 4 of Sample Size, we have

* MTP = Westfall-Young Single Step
* Number_Of_Outcomes = 5
* Number_Of_FalseNulls = 3
* Type_of_Sample = Blocked_or_within_block
* Number_of_Blocks = XX (We are providing starting values here?)
...
```{r}
test_case_4 <- sample_blocked_i1_2c(M = 5, 
                               numFalse = 5, 
                               typesample = "J", 
                               J = NULL, 
                               n.j = 20, 
...
For test case 5 of Sample Size, we have

* MTP = Westfall-Young Step Down
* Number_Of_Outcomes = 5
* Number_Of_FalseNulls = 3
* Type_of_Sample = Blocked_or_within_block
* Number_of_Blocks = XX (We are providing starting values here?)
...
```{r}
test_case_5 <- sample_blocked_i1_2c(M = 5, 
                               numFalse = 5, 
                               typesample = "J", 
                               J = NULL, 
                               n.j = 20, 
