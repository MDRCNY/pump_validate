...
We introduce the power under multiplicity project (`PUMP`) `R` package as a tool for analysts to estimate statistical power, minimum detectable effect size, and sample size requirements for multi-level RCTs.
