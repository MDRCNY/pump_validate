---
title: "Validate Power: cluster_c2_3r"
...
cluster_c2_3r_nj100_power_plot <- gen.power.results.plot(params.file.base, design)
print(cluster_c2_3r_nj100_power_plot)
```
...
```{r 3r.nj75}
cluster_c2_3r_nj75_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(cluster_c2_3r_nj75_power_plot)
```
...
```{r 3r.nj50}
cluster_c2_3r_nj50_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(cluster_c2_3r_nj50_power_plot)
```
...
```{r 3r.r2.10.6}
cluster_c2_3r_r2.1_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(cluster_c2_3r_r2.1_power_plot)
...
```{r 3r.r2.20.6}
cluster_c2_3r_r2.2_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(cluster_c2_3r_r2.2_power_plot)
...
```{r 3r.r2.30.6}
cluster_c2_3r_r2.3_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(cluster_c2_3r_r2.3_power_plot)
...
```{r 3r.rho0.2}
cluster_c2_3r_rho0.2_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(cluster_c2_3r_rho0.2_power_plot)
```
...
```{r 3r.rho0.8}
cluster_c2_3r_rho0.8_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(cluster_c2_3r_rho0.8_power_plot)
# reset
...
```{r 3r.MDES0.12500}
cluster_c2_3r_mdes0.1250.00.0.00_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(cluster_c2_3r_mdes0.1250.00.0.00_power_plot)
...
```{r 3r.ICC20.8}
cluster_c2_3r_ICC2.0.5_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(cluster_c2_3r_ICC2.0.5_power_plot)
...
```{r 3r.ICC30.8}
cluster_c2_3r_ICC3.0.8_power_plot <- gen.power.results.plot(gen_params_file_base(user.params.list, sim.params.list, design), design)
print(cluster_c2_3r_ICC3.0.8_power_plot)
