...
```{r 3r_nj50}
d3.3_m3rc2rc_nj50_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, design), design)
...
```{r 3r_nj75}
d3.3_m3rc2rc_nj75_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, design), design)
...
```{r 3r_r2106}
d3.3_m3rc2rc_r2.1_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, design), design)
...
```{r 3r_r2206}
d3.3_m3rc2rc_r2.2_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, design), design)
...
```{r 3r_r2306}
d3.3_m3rc2rc_r2.3_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, design), design)
...
```{r 3r_rho02}
d3.3_m3rc2rc_rho0.2_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, design), design)
...
```{r 3r_rho08}
d3.3_m3rc2rc_rho0.8_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, design), design)
...
```{r 3r_MDES012500}
d3.3_m3rc2rc_mdes0.1250.00.0.00_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, design), design)
...
```{r 3r_ICC207}
d3.3_m3rc2rc_ICC2.0.7_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, design), design)
...
```{r 3r_ICC307}
d3.3_m3rc2rc_ICC3.0.7_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, design), design)
...
```{r 3r_ICC20}
d3.3_m3rc2rc_ICC2.0_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, design), design)
...
```{r 3r_ICC30}
d3.3_m3rc2rc_ICC3.0_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, design), design)
