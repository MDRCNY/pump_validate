...
levels(validtable$method_adjname) <- c("rawp", "BF", "HO", "BH", "WY-SD", "WY-SS")
...
#table aesthetics
kable(validtable[, 2:12], caption = "MTP Used and Correlations") %>%
  ...
  # for M=1, look up in Power-Up
    #app to generate power can be found here https://metinbulus.shinyapps.io/powerupr/
      ...
      #power from PowerUp! app: 0.1662404  - what is n? unclear

      #extract M=1 power from our methods
      power.rawpind <- validtable[which(validtable$method_adjname =="rawp" & validtable$method_correlation == "0"), "method_indiv"]
      power.rawpind <- as.numeric(levels(power.rawpind))[power.rawpind]
