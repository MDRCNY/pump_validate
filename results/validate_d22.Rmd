...
```{r 2r_nj50}
d2.2_m2rc_nj50_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, d_m), d_m)
...
d2.2_m2rc_nj100_power_plot <- gen.power.results.plot(params.file.base, d_m)
...
```{r 2r_nj75}
d2.2_m2rc_nj75_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, d_m), d_m)
...
```{r 2r_r2106}
d2.2_m2rc_r2.1_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, d_m), d_m)
...
```{r 2r_r2206}
d2.2_m2rc_r2.2_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, d_m), d_m)
...
```{r 2r_rho02}
d2.2_m2rc_rho0.2_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, d_m), d_m)
...
```{r 2r_rho08}
d2.2_m2rc_rho0.8_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, d_m), d_m)
...
```{r 2r_MDES012500}
d2.2_m2rc_mdes0.1250.00.0.00_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, d_m), d_m)
...
```{r 2r_ICC207}
d2.2_m2rc_ICC2.0.7_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, d_m), d_m)
...
```{r 2r_ICC20}
d2.2_m2rc_ICC2.0_power_plot <- gen.power.results.plot(gen_params_file_base(model.params.list, sim.params.list, d_m), d_m)
...
} else
{
  ...
  pander::pandoc.table(
    d2.2_m2rc_sample_D1_J_results[,1:4],
    style = "grid", split.tables = 100, row.names = FALSE,
    caption = d_m
  )
}
...
} else
{
  ...
  pander::pandoc.table(
    d2.2_m2rc_sample_D1_nbar_results[,1:4],
    style = "grid", split.tables = 100, row.names = FALSE,
    caption = d_m
  )
}
