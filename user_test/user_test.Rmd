...
- Optional materials: If you would like more detail, see the attached paper or the supplementary materials.

Note that the optional materials are pretty long, and our intention is for users to be able to use the package without them, and only refer to them if someone wants more detail.
So if you are stuck, you can just note that you didn't know how to answer the question with just the vignette and package documentation.
...
- Did you end up referring to the paper or supplementary materials?
