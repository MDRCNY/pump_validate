...
### Test case 8 for Power using initial specifications before going into the MDES function

```{r}
power.blockedRCT.2(M = 6, MDES = 0.125, Ai = 6, J = 20, n.j = 100, p = 0.5, alpha = 0.05, numCovar.1 = 0, numCovar.2 = 0, R2.1 = 0, R2.2 = 0, tnum = 10000, snum = 2000, mod.type = c, ncl = 2, sigma = 0, omega = NULL)
```

### Test case 9 for Power using specifications put into the power function

```{r}
power.blockedRCT.2(M = 6, MDES = 0.5, Ai = 6, J = 20, n.j = 100, p = 0.5, alpha = 0.05, numCovar.1 = 0, numCovar.2 = 0, R2.1 = 0, R2.2 = 0, tnum = 10000, snum = 2000, mod.type = c, ncl = 2, sigma = 0, omega = NULL)
```
...
```{r}
#Testing service
dat <- data.frame(c(4,3,5,1,2), c("Z", "A", "C", "B", "E"))
colnames(dat) <- c("num", "letter")
head(dat)
