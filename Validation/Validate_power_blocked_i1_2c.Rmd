...
blocked_i1_2c_power_results_nj100 <- readRDS(power.file)
...
# )
pander::pandoc.table(
  blocked_i1_2c_power_results_nj100,
...
params.file.base <- gen_params_file_base(user.params.list, sim.params.list, design)
power.file <- find_file(params.file.base, type = 'power')
blocked_i1_2c_power_results_nj75 <- readRDS(power.file)
...
pander::pandoc.table(
  blocked_i1_2c_power_results_nj75,
  style = "grid", split.tables = 100
)
```
...
params.file.base <- gen_params_file_base(user.params.list, sim.params.list, design)
power.file <- find_file(params.file.base, type = 'power')
blocked_i1_2c_power_results_nj50 <- readRDS(power.file)
...
pander::pandoc.table(
  blocked_i1_2c_power_results_nj50,
