...
\begin{center}\includegraphics{arxiv_files/figure-latex/plotsamplepowercurve-1} \end{center}
...
\begin{center}\includegraphics{arxiv_files/figure-latex/othercorrections-1} \end{center}
...
\NormalTok{grid }\OtherTok{\textless{}{-}}\NormalTok{ dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{( grid, MTP }\SpecialCharTok{==} \StringTok{"HO"}\NormalTok{ )}
...
\begin{center}\includegraphics{arxiv_files/figure-latex/unnamed-chunk-11-1} \end{center}
...
\begin{center}\includegraphics{arxiv_files/figure-latex/unnamed-chunk-14-1} \end{center}
...
\begin{center}\includegraphics{arxiv_files/figure-latex/unnamed-chunk-17-1} \end{center}
