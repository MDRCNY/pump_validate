...
blocked_i1_2c_nj100_power_plot <- gen.results.plot(params.file.base)
...
blocked_i1_2c_nj75_power_plot <- gen.results.plot(gen_params_file_base(user.params.list, sim.params.list, design))
...
blocked_i1_2c_nj50_power_plot <- gen.results.plot(gen_params_file_base(user.params.list, sim.params.list, design))
