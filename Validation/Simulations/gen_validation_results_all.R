...
power.results <- validate_power(user.params.list, sim.params.list, design = "simple_c2_3r", q = q, overwrite)
...
{
  scenarios = ifelse(run.mdes.ss, 25, 16)
