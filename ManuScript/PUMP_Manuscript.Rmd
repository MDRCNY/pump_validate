...
Under the alternative hypothesis, $t_m$ has a $t$ distribution with degrees of freedom $df$ and mean $\frac{\hat{ES}_m}{\hat{Q}_m}$
...
A more detailed explanation of the validation procedure can be found in the Appendix, and full validation code and results are in our github repository.
