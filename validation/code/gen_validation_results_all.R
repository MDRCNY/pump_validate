...
if(run.power.def & run.power)
{
  ...
  model.params.list$R2.1 <- rep(0.1, 3)
  model.params.list$R2.2 <- rep(0.7, 3)
  model.params.list$ICC.2 <- rep(0.05, 3)
  model.params.list$ICC.3 <- rep(0.4, 3)
  ...
  model.params.list$R2.1 <- rep(0.3, 3)
  model.params.list$R2.2 <- rep(0.75, 3)
  model.params.list$ICC.2 <- rep(0.05, 3)
  model.params.list$ICC.3 <- rep(0.4, 3)
  model.params.list$rho <- 0.4
  power.results <- validate_power(model.params.list, sim.params.list, d_m = "d3.2_m3ff2rc", q = q, overwrite)
  ...
  model.params.list$nbar <- 150
  model.params.list$R2.1 <- rep(0.25, 3)
  model.params.list$R2.2 <- rep(0.75, 3)
  model.params.list$ICC.2 <- rep(0.05, 3)
  model.params.list$ICC.3 <- rep(0.4, 3)
  model.params.list$rho <- 0.4
  ...
  model.params.list$K <- 18
  model.params.list$nbar <- 170
  model.params.list$R2.1 <- rep(0.25, 3)
  model.params.list$R2.2 <- rep(0.75, 3)
  model.params.list$ICC.2 <- rep(0.05, 3)
  model.params.list$ICC.3 <- rep(0.4, 3)
