...
The MDES goes up, as expected. \textcolor{red}{KH: add one sentence explaining why this is expected? KP suggestion: When there are not effects on all outcomes, the probability of detecting the effects that do actually exist is diminished. Therefore, an increased MDES is required to achieve the same level of desired power (80 percent). Below we provide a deeper dive into the extent to which numZero can effect power estimates.}
