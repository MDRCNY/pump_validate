...
Map(cbind, list_of_simpwr, corr=corrlist)
...
#simpwr.cor <- "Blocked_i1_2cM3n.j100J20ICC0MDES0.125_S2000B10000_R2.10_R2.20_simpwrLIST.Rda"
...
# Pull in power calculations matrices via the app
```{r}
M <- 6
MDES <- 0.125
Ai <- 6
