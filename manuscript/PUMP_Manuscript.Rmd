...
We assume 50% of the schools are treated; our \textcolor{red}{calculates} will be approximate here in that we could not actually treat exactly 50% in small and odd-sized blocks.
...
The MDES goes up, as expected. \textcolor{red}{KH: add one sentence explaining why this is expected?}
