...
#merge mtp after append, rownmaes still hold so okay to do 
...
# Verify power calculations against MC methods: Replicate appendix table in report

```{r chunk3_verifyPower}
#manipulate data frames to make a combined table
# append lists into one dataset

library(plyr)
df <- ldply(simpwr, data.frame)
